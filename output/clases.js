...
function () {
  ...
  _createClass(Usuario, [{
    key: "mostarInfo",
    value: function mostarInfo(item) {
      return item;
    }
  }, {
    key: "mostarInfo2",
    value: function mostarInfo2() {
...
function (_Usuario) {
  ...
  function Estudiante(nombre, apellido, edad, carrera) {
    var _this;

    _classCallCheck(this, Estudiante);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(Estudiante).call(this, nombre, apellido, edad));
  ...
  return Estudiante;
}(Usuario); //instanciamos el objeto y sus atributos


var carlos = new Usuario('carlos', 'scarpa', 36);
console.log(carlos);
document.write(carlos.mostarInfo2());
var teo = new Estudiante('teo', 'skarp', 26, 'developer');
